...
class DoaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Mendapatkan referensi ke MaterialCardView
        val btnBackdoa: MaterialCardView = findViewById(R.id.btnBackdoa)

        // Menambahkan onClickListener untuk berpindah ke MainActivity
        btnBackdoa.setOnClickListener {
